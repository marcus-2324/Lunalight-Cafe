...
<html>
<head>
    <title>Edit Menu Item - Lunalight Café</title>
...
<body class="d-flex align-items-center justify-content-center py-5">
    <div class="card shadow-lg border-0 rounded-4" style="max-width: 700px; width: 100%;">
        <div class="card-body p-5">
            <h2 class="text-center fw-bold mb-4">✏️ Edit Menu Item</h2>

            <form action="process_edit_menu.php" method="post">
                <input type="hidden" name="USER_ID" value="<?php echo $USER_ID; ?>">
                <input type="hidden" name="ITEM_ID" value="<?php echo $item['ITEM_ID']; ?>">

                <div class="mb-3">
                    <label class="form-label fw-medium">Item Name</label>
                    <input type="text" name="ITEM_NAME" class="form-control rounded-3" value="<?php echo $item['ITEM_NAME']; ?>" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" name="PRICE" class="form-control rounded-3" value="<?php echo $item['PRICE']; ?>" required>
                </div>

                <div class="mb-3">
                    <label class="form-label fw-medium">Description</label>
                    <textarea name="DESCRIPTION" class="form-control rounded-3" rows="3"><?php echo $item['DESCRIPTION']; ?></textarea>
                </div>
                ...
                <div class="d-flex gap-2">
                    ...
                    <button type="submit" class="btn btn-warning w-100 rounded-3 fw-semibold flex-fill">Update Menu Item</button>
                </div>
            </form>
        </div>
    </div>
